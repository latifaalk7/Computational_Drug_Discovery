...
# 🤖 7. Future Machine Learning Work

This project provides a foundation for moving from **descriptive cheminformatics** toward **predictive machine learning**.

The next stage would be to use the molecular fingerprints and physicochemical descriptors as features in a machine-learning model.
...
```text
              ...
              ┌─────────────┴─────────────┐
              ↓                           ↓
       Morgan Fingerprints       Physicochemical
                                  Descriptors
              └─────────────┬─────────────┘
                            ↓
...
Instead of eight example drugs, thousands of compounds could be analysed.

A larger dataset would provide more information for identifying relationships between molecular structure and biological activity.

### 2. Predict IC50

Regression models could be trained to predict biological potency from molecular fingerprints and descriptors.
...
### 3. Compare molecular representations
...
could be compared to determine which representation provides the strongest predictive performance.

### 4. Investigate Structure–Activity Relationships

A larger dataset could be used to investigate **Structure–Activity Relationships (SAR)** and identify structural modifications associated with changes in biological activity.

### 5. Evaluate model performance

A future model could be evaluated using metrics such as:
...
This would allow the project to move beyond:

> **"What patterns exist in the data?"**

towards:

> **"Can we use those patterns to predict the activity of a new molecule?"**
